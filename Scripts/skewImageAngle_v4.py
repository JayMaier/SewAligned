...
# Changes: v4 - changed structure to be more realistic of running, allowed for
#   reading in pdf as a jpg, using the larger calibration size, and relative paths
###########################################
...
# Set up locations
folderLoc = '..\\'; 
rectImageLoc = folderLoc + '5ft_angle.jpg';

fileLoc = folderLoc + 'croppedCalibration2.pdf';

sidneyPopplerPath = "..\\poppler\\Release-20.12.1\\poppler-20.12.1\\Library\\bin";
...
pages = convert_from_path(fileLoc, dpi=300, poppler_path = sidneyPopplerPath, fmt='jpg');
# convert the jpg format to an array we can manipulate later
patternImg = np.array(pages[0])
...
# NOTE: cv2 imshow doesn't work well for objects sized larger than the computer
#   screen. Use matplotlib imshow for these larger files
